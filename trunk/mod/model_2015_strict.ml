...
// objectproperty
!labelEQ(l_o1, l_o2) v !opropHasLabel_o1(o_o1, l_o1) v !opropHasLabel_o2(o_o2, l_o2) v !opropDom_o1(o_o1, cd_o1) v !opropDom_o2(o_o2, cd_o2) v !conceptEQ(cd_o1, cd_o2) v !opropRan_o1(o_o1, cr_o1) v !opropRan_o2(o_o2, cr_o2) v !conceptEQ(cr_o1, cr_o2) v opropEQ(o_o1, o_o2).
// the case when the label is empty (allow only matches to other properties with empty labels)
!has0Word_o1(l_o1) v !has0Word_o2(l_o2) v !opropHasLabel_o1(o_o1, l_o1) v !opropHasLabel_o2(o_o2, l_o2) v !opropDom_o1(o_o1, cd_o1) v !opropDom_o2(o_o2, cd_o2) v !conceptEQ(cd_o1, cd_o2) v !opropRan_o1(o_o1, cr_o1) v !opropRan_o2(o_o2, cr_o2) v !conceptEQ(cr_o1, cr_o2) v opropEQ(o_o1, o_o2). 

// dataproperty
!labelEQ(l_o1, l_o2) v !dpropHasLabel_o1(d_o1, l_o1) v !dpropHasLabel_o2(d_o2, l_o2) v !dpropDom_o1(d_o1, cd_o1) v !dpropDom_o2(d_o2, cd_o2) v !conceptEQ(cd_o1, cd_o2) v dpropEQ(d_o1, d_o2).
// the case when the label is empty (allow only matches to other properties with empty labels)
!has0Word_o1(l_o1) v !has0Word_o2(l_o2) v !dpropHasLabel_o1(d_o1, l_o1) v !dpropHasLabel_o2(d_o2, l_o2) v !dpropDom_o1(d_o1, cd_o1) v !dpropDom_o2(d_o2, cd_o2) v !conceptEQ(cd_o1, cd_o2) v dpropEQ(d_o1, d_o2).


// Match ENTITY ===>>> Match LABEL (or label is 0word) and MATCH Domain and Range
// if two entities are equiv then their labels are equiv
// concept
!conceptEQ(c_o1, c_o2) v !conceptHasLabel_o1(c_o1, l_o1) v !conceptHasLabel_o2(c_o2, l_o2) v labelEQ(l_o1, l_o2).
// objectproperty
!opropEQ(o_o1, o_o2) v !opropHasLabel_o1(o_o1, l_o1) v !opropHasLabel_o2(o_o2, l_o2) v has0Word_o1(l_o1) v has0Word_o2(l_o2) v labelEQ(l_o1, l_o2).
!opropEQ(o_o1, o_o2) v !opropHasLabel_o1(o_o1, l_o1) v !opropHasLabel_o2(o_o2, l_o2) v !has0Word_o1(l_o1) v has0Word_o2(l_o2).
!opropEQ(o_o1, o_o2) v !opropHasLabel_o1(o_o1, l_o1) v !opropHasLabel_o2(o_o2, l_o2) v !has0Word_o2(l_o2) v has0Word_o1(l_o1).
!opropEQ(o_o1, o_o2) v !opropDom_o1(o_o1, cd_o1) v !opropDom_o2(o_o2, cd_o1) v conceptEQ(cd_o1, cd_o2).
!opropEQ(o_o1, o_o2) v !opropRan_o1(o_o1, cr_o1) v !opropRan_o2(o_o2, cr_o1) v conceptEQ(cr_o1, cr_o2).
// dataproperty
!dpropEQ(d_o1, d_o2) v !dpropHasLabel_o1(d_o1, l_o1) v !dpropHasLabel_o2(d_o2, l_o2) v has0Word_o1(l_o1) v has0Word_o2(l_o2) v labelEQ(l_o1, l_o2).
!dpropEQ(d_o1, d_o2) v !dpropHasLabel_o1(d_o1, l_o1) v !dpropHasLabel_o2(d_o2, l_o2) v !has0Word_o1(l_o1) v has0Word_o2(l_o2).
!dpropEQ(d_o1, d_o2) v !dpropHasLabel_o1(d_o1, l_o1) v !dpropHasLabel_o2(d_o2, l_o2) v !has0Word_o2(l_o2) v has0Word_o1(l_o1).
!dpropEQ(d_o1, d_o2) v !dpropDom_o1(d_o1, cd_o1) v !dpropDom_o2(d_o2, cd_o1) v conceptEQ(cd_o1, cd_o2).


// *** the rule for matching 0-word labels on 0-word labels (never match the labels) ***
!has0Word_o1(l1_o1) v !has0Word_o2(l1_o2) v !labelEQ(l1_o1, l1_o2).
